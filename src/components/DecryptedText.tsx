...
export default function DecryptedText({
  ...
  // Reset state when the driving props change ("adjust state during render" pattern,
  // https://react.dev/learn/you-might-not-need-an-effect).
  const [prevInit, setPrevInit] = useState<{ animateOn: string; text: string } | null>(null);
  if (prevInit === null || prevInit.animateOn !== animateOn || prevInit.text !== text) {
    setPrevInit({ animateOn, text });
    if (animateOn === 'click') {
      setDisplayText(shuffleText(text, new Set()));
      setIsDecrypted(false);
    } else {
